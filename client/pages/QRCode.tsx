  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="py-16 bg-walmart-gray-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            {/* Left - Features */}
            <div>
              <h2 className="text-3xl font-bold text-walmart-text mb-6">
                Como Funciona
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-walmart-blue text-white">
            ...
            <div className="hidden md:flex justify-center">
              <div className="w-80 h-80 bg-white rounded-lg shadow-lg flex items-center justify-center border-4 border-walmart-blue">
                <QrCode className="w-32 h-32 text-walmart-blue opacity-75" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-walmart-text mb-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-walmart-gray-light rounded-lg p-8">
              <div className="w-12 h-12 bg-walmart-blue bg-opacity-10 rounded-lg flex items-center justify-center mb-4">
                <Zap className="w-6 h-6 text-walmart-blue" />
              </div>
            ...
            <div className="bg-walmart-gray-light rounded-lg p-8">
              <div className="w-12 h-12 bg-walmart-blue bg-opacity-10 rounded-lg flex items-center justify-center mb-4">
                <AlertCircle className="w-6 h-6 text-walmart-blue" />
              </div>
              <h3 className="text-xl font-bold text-walmart-text mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 rounded-full bg-walmart-yellow flex items-center justify-center text-walmart-text text-sm font-bold flex-shrink-0 mt-1">
                  ✓
                </div>
                <div>
                  <h4 className="font-bold text-walmart-text">
                    Gerador de QR Code
                  </h4>
      ...
      {/* CTA Section */}
      <section className="bg-walmart-blue text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/auth/signup"
              className="inline-flex items-center justify-center space-x-2 bg-walmart-yellow text-walmart-text px-8 py-3 rounded-lg font-semibold hover:bg-walmart-yellow-dark transition-colors"
            >
