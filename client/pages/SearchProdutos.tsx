...
export default function SearchProdutos() {
  ...
  const priceMap = useMemo(() => {
    const map: Record<
      number,
      Array<{ preco: number; tamanho?: string; cor?: string }>
    > = {};
              ...
              {isLoading ? (
                ...
                <div className="space-y-8">
                  {Object.values(organizedData).map((storeData: any) => {
                    const storeProducts = Object.values(
                      storeData.groups,
                    ).reduce(
                      ...
                      <div key={storeData.store.id}>
                        ...
                        {expandedStore === storeData.store.id && (
                          <div className="space-y-4 mb-8">
                            {Object.values(storeData.groups).map(
                              (groupData: any) => {
