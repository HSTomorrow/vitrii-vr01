    ...
    <div className="space-y-6">
      ...
      {categoria === "roupas" && (
        <div className="bg-blue-50 rounded-lg p-4 space-y-4 border border-blue-200">
          <h3 className="font-bold text-vitrii-text">Informações da Roupa</h3>
      ...
      {categoria === "carros" && (
        <div className="bg-blue-50 rounded-lg p-4 space-y-4 border border-blue-200">
          <h3 className="font-bold text-vitrii-text">Informações do Veículo</h3>
      ...
      {categoria === "imoveis" && (
        <div className="bg-blue-50 rounded-lg p-4 space-y-4 border border-blue-200">
          <h3 className="font-bold text-vitrii-text">Informações do Imóvel</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="mobiliado" className="text-sm font-semibold text-vitrii-text">
                Mobiliado
              </label>
            </div>
          </div>
