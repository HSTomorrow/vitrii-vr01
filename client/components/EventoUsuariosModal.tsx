...
interface EventoUsuariosModalProps {
  isOpen: boolean;
  onClose: () => void;
  eventoId: number;
  anuncianteId: number;
...
export default function EventoUsuariosModal({
  isOpen,
  onClose,
  eventoId,
  anuncianteId,
        ...
        <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
          ...
          <div className="p-6 text-center">
            <p className="text-gray-600">
              Apenas o responsável pela agenda pode gerenciar usuários.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <label className="block text-sm font-semibold text-vitrii-text mb-3">
              Usuários Vinculados ({linkedUsuarios.length})
            </label>
            {isLoadingLinked ? (
                ...
                {linkedUsuarios.map((usuario) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      disabled={isRemoving === usuario.id}
