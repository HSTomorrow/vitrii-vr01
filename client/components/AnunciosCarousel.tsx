              ...
              {anuncio.tipo === "servico" ? (
                <div className="flex gap-2">
                  <Link
                    ...
                    className={`flex-1 text-white py-2 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 ${colors.button}`}
                  >
                  ...
                  <button
                    onClick={() => navigate(`/anuncio/${anuncio.id}`)}
                    className={`flex-1 text-white py-2 rounded-lg font-semibold transition-colors ${colors.button}`}
                  >
                    Detalhes
                  </button>
                </div>
                ...
                <button
                  onClick={() => navigate(`/anuncio/${anuncio.id}`)}
                  className={`w-full text-white py-2 rounded-lg font-semibold transition-colors ${colors.button}`}
                >
                  Ver Detalhes
                </button>
              )}
