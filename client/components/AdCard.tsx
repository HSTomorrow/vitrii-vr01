  ...
  return (
    <div className="vitrii-card card-hover overflow-hidden cursor-pointer relative">
      ...
      <div className="p-[0.95rem] flex flex-col h-full">
        <div>
          <h4 className="text-heading-3 font-semibold text-vitrii-text mb-[0.475rem] line-clamp-2">
            {anuncio.titulo}
          </h4>
          <p className="text-sm-body mb-[0.7125rem] line-clamp-2">
            {anuncio.descricao ||
              (isDonation
          ...
          {/* Municipality */}
          <div className="flex items-center gap-1 mb-[0.7125rem] text-xs-label">
        ...
        <div className="flex justify-between items-center mb-[0.95rem] mt-auto">
          <span
            className={`text-price font-bold ${isDonation ? "text-green-600" : "text-vitrii-blue"}`}
          >
            {isDonation
              ? "Grátis"
